...
Download `adb_6u05yg3qpvq59_v29836.msi` from release `v93285` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v93285` for pilot groups.
